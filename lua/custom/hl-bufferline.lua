...
function M.hl(params)
  ...
  return {
    ...
    background = if_not_nil({ fg = c.inactive_fg }),
    ...
    warning = if_not_nil({ fg = c.inactive_fg }),
    warning_visible = if_not_nil({ bg = c.inactive_bg, fg = c.inactive_fg }),
    warning_diagnostic = if_not_nil({ fg = dark_palette.yellow }),
    ...
    error = if_not_nil({ fg = c.inactive_fg }),
